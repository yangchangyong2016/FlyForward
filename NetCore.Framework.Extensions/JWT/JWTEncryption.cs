...
namespace NetCore.Framework.Extensions
{
    /// <summary>
    /// JWT 加解密
    /// </summary>
    public class JWTEncryption
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static JWTOptionsSettings GetJWTSettings()
        {
            return InternalHttpContext.Current()?.RequestServices?.GetService<IOptions<JWTOptionsSettings>>()?.Value;
        }
        ...
        /// <returns></returns>
        public static TokenValidationParameters CreateTokenValidationParameters(JWTOptionsSettings jwtSettings)
        {
        ...
        /// <returns></returns>
        private static (Dictionary<string, object> Payload, JWTOptionsSettings JWTSettings) CombinePayload(Dictionary<string, object> payload, long? expiredTime = null)
        {
            var jwtSettings = GetJWTSettings();
